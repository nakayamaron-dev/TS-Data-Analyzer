            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6" *ngFor="let itm of setting.items; index as i">
                        ...
                        <select 
                        #tagSelect class="form-select textColor SecondaryBGColor"
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <br>
                                <input #bin type="text" [value]="itm.bin" 
                                (input)="setBin(bin.value, i)" class="textColor SecondaryBGColor" 
                                style="width: 30%; border-color: white; border-width: 1px">
                            </div>
                        </form>
                    </div>
                    <fa-icon *ngIf="setting.items.length < 2" class="col-1 PrimaryColor" [icon]="plusIcon"
