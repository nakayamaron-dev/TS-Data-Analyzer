              ...
              <form>
                <div class="mb-3">
                  ...
                  <input
                    #xrangeMin
                    type="text"
                    [value]="setting.xrange?.min"
                    (input)="setTagXrangeMin(xrangeMin.value)"
                ...
                <div class="mb-3">
                  ...
                  <input
                    #xrangeMax
                    type="text"
                    [value]="setting.xrange?.max"
                    (input)="setTagXrangeMax(xrangeMax.value)"
                    class="textColor SecondaryBGColor"
                    style="width: 75%; border-color: white; border-width: 1px"
                  />
                </div>
              ...
              <form>
                <div class="mb-3">
                  ...
                  <input
                    ...
                    (input)="setTagYrangeMin(yrangeMin.value)"
                    class="textColor SecondaryBGColor"
                    style="width: 75%; border-color: white; border-width: 1px"
                  />
                </div>
                <div class="mb-3">
                  ...
                  <input
                    ...
                    (input)="setTagYrangeMax(yrangeMax.value)"
                    class="textColor SecondaryBGColor"
                    style="width: 75%; border-color: white; border-width: 1px"
                  />
                </div>
